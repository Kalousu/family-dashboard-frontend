...
function ToDoWidget({ widgetId = 1 }: { widgetId?: number }) {
    ...
    return (
        <div ref={ref} className="w-full h-full bg-linear-to-b from-orange-400/30 to-yellow-200/30 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg overflow-hidden">
            <div
