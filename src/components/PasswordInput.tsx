        ...
        <div className="flex flex-row items-center gap-2">
            <div className="rounded-xl p-0.5 bg-linear-to-b to-gray-400 via-gray-600/50 from-gray-400/50">
                <input 
                    ...
                    className="px-4 py-2 rounded-xl focus:outline-none bg-gray-200 text-sm border border-white/70" 
                    type="password" 
                    placeholder="Passwort" />                
            </div>
            <div className="overflow-hidden rounded-full p-px bg-gray-500/80 transition-all  hover:scale-104 hover:brightness-110  ease-in-out">
